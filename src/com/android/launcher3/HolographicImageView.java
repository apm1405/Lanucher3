...
public class HolographicImageView extends ImageView {
    ...
    protected void drawableStateChanged() {
		...
		// M: judge whether the image has been layout or not, if has been
		// layouted, the bounds is not empty, but if
		// not be layout, then the bound is empty, if empty, we can't draw
		// anything on it.
