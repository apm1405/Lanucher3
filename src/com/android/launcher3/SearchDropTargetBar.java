...
public class SearchDropTargetBar extends FrameLayout implements DragController.DragListener {
    ...
    public void setup(Launcher launcher, DragController dragController) {
        ...
        if (mEnableDropDownDropTargets) {
			/// HOSIN: hide search bar
            mQSBSearchBarAnim = ObjectAnimator.ofFloat(mQSBSearchBar, "translationY", 
					(com.mediatek.common.featureoption.FeatureOption.HOSIN_HIDE_SEARCH_BAR)
						? -mBarHeight
						: 0,
                    -mBarHeight);
        } else {
			/// HOSIN: hide search bar
            mQSBSearchBarAnim = ObjectAnimator.ofFloat(mQSBSearchBar, "alpha", 
				(com.mediatek.common.featureoption.FeatureOption.HOSIN_HIDE_SEARCH_BAR)
						? 0f
						: 1f, 
				0f);
    ...
    public void showSearchBar(boolean animated) {
        ...
        if (animated) {
            ...
            if (mEnableDropDownDropTargets) {
				/// HOSIN: hide search bar
                mQSBSearchBar.setTranslationY((com.mediatek.common.featureoption.FeatureOption.HOSIN_HIDE_SEARCH_BAR)
						? -mBarHeight
						: 0);
            } else {
				/// HOSIN: hide search bar
                mQSBSearchBar.setAlpha((com.mediatek.common.featureoption.FeatureOption.HOSIN_HIDE_SEARCH_BAR)
						? -1f
						: 0f);
            }
        }
    ...
    public void onDragStart(DragSource source, Object info, int dragAction) {
		...
		/// HOSIN: place search-drop bar in the same place of status-bar  @{
