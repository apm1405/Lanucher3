...
public class LauncherProvider extends ContentProvider {
    ...
    static final String TABLE_WORKSPACE_SCREENS = "workspaceScreens";
	 static final String TABLE_WALLPAPER = "wallpaper";//add by messi for HOSIN_CUST_LAUNCHER_MESSI
    ...
    static final Uri CONTENT_APPWIDGET_RESET_URI =
	  ...
	  static final Uri WALLPAPER_URI =   Uri.parse("content://" + AUTHORITY + "/wallpaper");//add by messi for 	HOSIN_CUST_LAUNCHER_MESSI
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            db.execSQL("CREATE TABLE favorites (" +
                    ...
                    ");");
				// add by messi for wallpaper set  start
		if(FeatureOption.HOSIN_CUST_LAUNCHER_MESSI){
            db.execSQL("CREATE TABLE wallpaper ("+
				"_id INTEGER PRIMARY KEY,"+
                    "wallpaper BLOB,"+
                    "flag INTEGER,"+
                    "modified INTEGER NOT NULL DEFAULT 0);");
			}
			//add by messi for wallpaper set end
		...
		if(FeatureOption.HOSIN_CUST_LAUNCHER_MESSI){
		db.execSQL("DROP TABLE IF EXISTS " + TABLE_WALLPAPER);//messi add
		}
