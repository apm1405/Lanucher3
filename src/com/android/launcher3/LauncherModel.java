...
//chenyushun add 20140723 [HOSIN_CUBE_APPICON_DISAPPEAR]
...
public class LauncherModel extends BroadcastReceiver {
    ...
    private class LoaderTask implements Runnable {
        ...
        private boolean loadWorkspace() {
			...
			//chenyushun add 20140723 HOSIN_CUBE_APPICON_DISAPPEAR						
			if(FeatureOption.HOSIN_CUBE_APPICON_DISAPPEAR){
				//do nothing just for not excute follow statement
			}else{//chenyushun add this line
        ...
        private void loadAllApps() {
			...
			/// HOSIN: sort by installation time
    ...
    public ShortcutInfo getShortcutInfo(PackageManager manager, Intent intent, Context context,
        ...
        if (componentName != null && !isValidPackageComponent(manager, componentName)) {
            ...
            //chenyushun add 20140723 start [HOSIN_CUBE_APPICON_DISAPPEAR]
            if(FeatureOption.HOSIN_CUBE_APPICON_DISAPPEAR){
	...
	/// HOSIN: HOSIN_SORT_ALL_APPS_BY_INSTALLATION_TIME  sort apps by installation time  @{
	public static final Comparator<AppInfo> getInstallTimeComparator() {
		return new Comparator<AppInfo>() {
			public final int compare(AppInfo a, AppInfo b) {
				return a.firstInstallTime < b.firstInstallTime ? 1 : -1;  //">" for DESC, "<" for ACS
			}
		};
	}
	...
	public static class InstallTimeComparator implements Comparator<ResolveInfo> {
		...
		public final int compare(ResolveInfo a, ResolveInfo b) {
			...
			try{
				...
				e.printStackTrace(); // need to import java.lang.Exception; or, there will be compile err.
				return 0;
			}

			return firstInstallTimeA < firstInstallTimeB ? 1:-1; //">" for DESC, "<" for ACS
		}
	};
	/// HOSIN: HOSIN_SORT_ALL_APPS_BY_INSTALLATION_TIME  sort apps by installation time  @}
}
