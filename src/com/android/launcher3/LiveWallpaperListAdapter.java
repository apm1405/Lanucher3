...
public class LiveWallpaperListAdapter extends BaseAdapter implements ListAdapter {
    ...
    // /M: Filter Video Live Wallpaper @{
    private static final String VIDEOWALLPAPER_NAME = "com.mediatek.vlw.VideoLiveWallpaper";
    // @}
    ...
    private class LiveWallpaperEnumerator extends
        ...
        protected Void doInBackground(List<ResolveInfo>... params) {
            ...
            for (ResolveInfo resolveInfo : list) {
                ...
                // /M: Filter Video Live Wallpaper @{
                if (VIDEOWALLPAPER_NAME.equals(info.getServiceName())) {
                    Log.v(LOG_TAG, "Current live wallpaper is video wallpaper, filter it.");
                    continue;
                }
                // /@}
