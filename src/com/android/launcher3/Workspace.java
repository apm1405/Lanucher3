...
import android.widget.FrameLayout;//add 20140902 for HOSIN_CUST_LAUNCHER_MESSI
...
public class Workspace extends SmoothPagedView
    ...
    public static final int DRAG_BITMAP_PADDING =FeatureOption.HOSIN_CUST_LAUNCHER_MESSI ? 10 : 2;
    ...
    */
    ...
    Animator getChangeStateAnimation(final State state, boolean animated, int delay, int snapPage) {
        ...
        float finalSearchBarAlpha = !stateIsNormal
				? 0f 
